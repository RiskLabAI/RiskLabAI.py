...
def test_binomial_sharpe_ratio():
    ...
    sr = binomial_sharpe_ratio(
        stop_loss=-0.01, profit_taking=0.01, frequency=252, probability=0.5
    )
    ...
    sr_high_p = binomial_sharpe_ratio(
        stop_loss=-0.01, profit_taking=0.01, frequency=252, probability=0.6
    )
...
def test_mix_gaussians():
    ...
    n_obs = 1000
    p = 0.5
    mix = mix_gaussians(mu1=10, mu2=-10, sigma1=1, sigma2=1, probability=p, n_obs=n_obs)
