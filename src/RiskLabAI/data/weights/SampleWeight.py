...
"""
def mpSampleWeight(timestamp, # DataFrame of events start and end for labelling 
...
"""
def index_matrix(barIndex, #index of all data 
...
"""
def sequential_bootstrap(indexMatrix, #matrix that Indicator for events 
...
"""
def mpSampleWeightAbsoluteReturn(timestamp, # dataFrame for events 
...
"""
def timeDecay(weight, #weight that compute for each event 
