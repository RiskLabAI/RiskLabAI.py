...
# The required function 'purged_train_times' is imported from Python_Chapter_7 -> check this file for the function
from Python_Chapter_7 import purged_train_times
...
def calculate_backtest_paths(
    ...
    :param n_train_splits: Number of training splits.
...
class CombinatorialPurgedKFold(KFold):
    def __init__(
        ...
        if not isinstance(samples_info_sets, (pd.Series, dict)):
            raise ValueError('The samples_info_sets param must be a pd.Series or dictionary')
